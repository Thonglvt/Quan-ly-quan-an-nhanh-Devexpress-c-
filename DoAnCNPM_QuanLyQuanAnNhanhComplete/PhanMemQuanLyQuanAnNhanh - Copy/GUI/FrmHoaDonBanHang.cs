...
namespace GUI
{
    public partial class FrmHoaDonBanHang : DevExpress.XtraEditors.XtraForm
    {
        ...
        void loadSLE()
        {
            ...
            sleNV.Properties.DataSource = bllNV.getAll();
        ...
        private void gvHD_RowCellStyle(object sender, RowCellStyleEventArgs e)
        {
        ...
        private void btnThongKe_Click(object sender, EventArgs e)
        {
            if (cboThongKe.SelectedIndex == 0)
            {
                ...
                bllHDBH = new BLL_HoaDonBanHang();
                List<DTO_HoaDon_KH_NV_BG_SP> lst = bllHDBH.getHD_KH_NV_ByMaNV(sleNV.EditValue.ToString());
            ...
            else if (cboThongKe.SelectedIndex == 1)
            {
                ...
                bllHDBH = new BLL_HoaDonBanHang();
                List<DTO_HoaDon_KH_NV_BG_SP> lst = bllHDBH.getHD_KH_NV().Where(t => t.NgayLap >= Convert.ToDateTime(deNgayBD.EditValue) && t.NgayLap <= Convert.ToDateTime(deNgayKT.EditValue)).ToList();
                gcHoaDon.DataSource = lst;
                txtSoLuongKQ.Text = lst.Count.ToString();
                txtTongDoanhThu.Text = string.Format("{0:0,0 đ}", lst.Sum(t => t.TongTien));
            }
        ...
        private void sleNV_BeforePopup(object sender, EventArgs e)
        {
            loadSLE();
        }
        #endregion
