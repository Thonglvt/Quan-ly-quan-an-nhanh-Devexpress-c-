...
namespace GUI
{
    public partial class FrmNhanVien : DevExpress.XtraEditors.XtraForm
    {
        ...
        void loadData()
        {
            ...
            gcNhanVien.DataSource = bllNV.getAll();
        ...
        {
            if (!BLL_HamXuLy.CheckPhone(txtSDT.Text) && txtSDT.Text.Trim() != string.Empty)
            {
        ...
        private void btnLuuNV_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            string kqInsert = bllNV.insert(nv);
